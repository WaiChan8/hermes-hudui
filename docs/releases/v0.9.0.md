...
This release launches Hermes Replay as the HUD's local proof and publishing layer. It turns private Hermes sessions into redacted, shareable run receipts with exports, verification, screenshots, and local publish artifacts.
...
![Hermes Replay](../../assets/replay-tab.png)
